...
class WallSwitch extends Subdevice {
  ...
  onmessage(msg) {
    ...
    if ('channel_0' in msg.data) this.prop[this.channel[0]] = msg.data.channel_0;
    if ('channel_1' in msg.data) this.prop[this.channel[1]] = msg.data.channel_1;
  ...
  toggle(channel) {
    ...
    let state = (this.prop[channelName] !== 'on');
