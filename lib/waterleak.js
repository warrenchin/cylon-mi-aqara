...
class WaterLeak extends Subdevice {
  ...
  onmessage(msg) {
    ...
    if ('status' in msg.data) this.prop.leak = (msg.data.staus === 'leak');

    if (msg.cmd === 'report') {
      // { cmd: 'report', model: 'sensor_wleak.aq1', sid: '158d0001d779c6', short_id: 47495, data: { prop: 'no_leak' } }
      //{ cmd: 'report', model: 'sensor_wleak.aq1', sid: '158d0001d779c6', short_id: 47495, data: { prop: 'leak' } }
    }
